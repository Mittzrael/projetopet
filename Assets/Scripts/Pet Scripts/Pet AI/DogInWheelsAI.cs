...
/// <summary>
/// Script que herda PetBasicAI e possui as funções específicas do pet de cadeira de rodas (denomidado Wheels)
/// </summary>
public class DogInWheelsAI : PetBasicAI
{
    /// <summary>
    ...
    public IEnumerator PetRandomMove()
    {
        ...
        if (randomActionCountdown >= maxIdleTime)
        {
            ...
            else
            {
                ...
                {
                    case 0: // Pet uiva
                        Debug.Log("Movimento aleatório - Uivo");
                        // Chama a animação de uivar e aguarda
                        petAnimationScript.Howling();
