...
{
    public string panelActionsItemName;
    GameObject panelInventory;
    GameObject panelActionsItems;

    public static bool isPanelActionsItemsOpen = false;
    ...
    private void OnMouseDown()
    {
        ...
        {
            if(child.gameObject.name == panelActionsItemName)
            {
                child.gameObject.SetActive(true);
                panelInventory.SetActive(false);
                InventoryOpen.isInventoryOpen = false;
                isPanelActionsItemsOpen = true;
            }
        }
    }
}